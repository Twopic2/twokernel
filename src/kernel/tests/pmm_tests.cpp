...
namespace Tests {
    void run_pmm_tests() {
        ...
        *ptr = 0xCAFEBABEull;
        ...
        // multi-page alloc
        std::uintptr_t pa3 = Memory::Pmm::alloc(4);
